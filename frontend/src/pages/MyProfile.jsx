...
const MyProfile = () => {
   ...
   const { userData, setUserData, token, backendUrl, loadUserProfileData, calculateAge } = useContext(AppContext);
      ...
      <div className='max-w-lg flex flex-col gap-2 text-sm'>
         ...
         <div>
            ...
            <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
               ...
               <p className='text-gray-400'>{calculateAge(userData.dob)} years</p>
            </div>
         </div>
